    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="phone_no" class="block mt-1 w-full" type="text" name="phone_no" required placeholder="Enter 11 digit phone no"/>
            </div>
            ...
            <div class="mt-4">
                <x-label for="user_desc" value="{{ __('Description') }}" />
                <x-input id="user_description" class="block mt-1 w-full" type="text" name="user_description" required placeholder="Tell us about Yourself!"/>
            </div>
