        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('/posts') }}" class="nav-item nav-link"><i class="bi bi-file-earmark-music"></i>  Posts</a>
                    <a href="{{ url('/artists') }}" class="nav-item nav-link"><i class="bi bi-mic"></i>  Artists</a>
                    <a href="{{ url('/album') }}" class="nav-item nav-link"><i class="bi bi-journal-album"></i>  Albums</a>
                    <a href="{{ url('/genres') }}" class="nav-item nav-link"><i class="bi bi-music-player"></i>  Genre</a>
                    @endif
                </div>
            </nav>
        </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="">Sound Team</a>
                        </div>
                    </div>
                </div>
            </div>
